...
# You need to have the following line evaluated to get the www content // FALSE
# BUG ? The www loading seems not consistent ... ?
app

# to have the www folder work // FALSE, needs external runapp command...
